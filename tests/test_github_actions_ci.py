...
def test_offline_evaluation_job_runs_and_publishes_phase4_statistical_baseline() -> None:
    ...
    for test_path in (
        ...
        "tests/test_cuped_reference_cases.py",
        "tests/test_cuped_observability.py",
        "tests/test_cuped_service.py",
        "tests/test_sequential_reference_cases.py",
        "tests/test_sequential_observability.py",
        "tests/test_sequential_service.py",
        "tests/test_bayesian_binary.py",
        "tests/test_bayesian_continuous.py",
        "tests/test_bayesian_observability.py",
        "tests/test_bayesian_service.py",
        "tests/test_randomized_inference_reliability_fixtures.py",
        "tests/test_randomized_inference_reliability_evaluator.py",
        "tests/test_randomized_inference_reliability_policy.py",
        "tests/test_randomized_inference_reliability_telemetry.py",
        "tests/test_randomized_inference_reliability_artifacts.py",
    ):
