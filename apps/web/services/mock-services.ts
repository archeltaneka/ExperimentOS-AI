...
import { evaluationFixture, evaluationHistoryFixture } from "@/mock/evaluations";
...
export class MockEvaluationService implements EvaluationService { readonly source = fixtureSource; async getSummary() { return evaluationFixture; } async getHistory() { return evaluationHistoryFixture; } }
