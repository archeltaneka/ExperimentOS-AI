...
export interface AskSample { experimentId: string; question: string; }
export interface AskService { readonly source: DataSource; readonly samples?: readonly AskSample[]; ask(request: AskRequest): Promise<RagAnswer>; }
