...
class CausalDiagnosticCode(StrEnum):
    ...
    GRAPH_NOT_DAG = "graph.not_dag"
    GRAPH_MISSING_TREATMENT = "graph.missing_treatment"
    GRAPH_MISSING_OUTCOME = "graph.missing_outcome"
    GRAPH_UNOBSERVED_ENDPOINT = "graph.unobserved_endpoint"
    GRAPH_ADJUSTMENT_DESCENDANT = "graph.adjustment_descendant_of_treatment"
