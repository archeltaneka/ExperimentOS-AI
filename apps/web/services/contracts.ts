import type { DataSource, EvaluationHistoryPoint, EvaluationSummary, Experiment, ExperimentDetail, RagAnswer, RoadmapPhase } from "@/types/domain";
...
export interface EvaluationService { readonly source: DataSource; getSummary(signal?: AbortSignal): Promise<EvaluationSummary>; getHistory(signal?: AbortSignal): Promise<readonly EvaluationHistoryPoint[]>; }
